...
export function getList(namespace: string) {
 return request(`/apis/apps.kubeedge.io/v1alpha1/namespaces/${namespace}/edgeapplications`, {
  method: 'get'
 }) 
}
// 删除
export function removeItem(app: string) {
  return request(`/apis/apps.kubeedge.io/v1alpha1/namespaces/default/edgeapplications/${app}`, {
    method: 'delete',
  });
}
