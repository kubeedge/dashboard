            ...
            getList(sessionStorage.getItem("nameSpace")).then((res) => {
              return {
                data: res.items.map(item => {
                  return { name: item.metadata.name, uid: item.metadata.uid, creationTimestamp: item.metadata.creationTimestamp, source: item.spec.source, sourceResource: item.spec.sourceResource.path, target: item.spec.target, targetResource: item.spec.targetResource.path }
                }),
